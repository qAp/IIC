...
from IIC.datasets.segmentation.util import cocostuff_fine_to_coarse
from IIC.datasets.segmentation.util.cocostuff_fine_to_coarse import (
  generate_fine_to_coarse)
from IIC.utils.segmentation.render import render
from IIC.utils.segmentation.transforms import (
